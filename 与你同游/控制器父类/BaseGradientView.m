...
//  与你同游
//
//  Created by Zgmanhui on 15/11/25.
...
- (void)drawRect:(CGRect)rect {
    ...
    //绘制
    CGContextDrawLinearGradient(context, gradientRef, CGPointMake(CGRectGetMidX(self.bounds), 0), CGPointMake(CGRectGetMidX(self.bounds), 667), 0);
    //释放
