...
- (id)initWithText:(NSString *)text{
    if (self = [super init]) {
        ...
        UIFont *font = [UIFont boldSystemFontOfSize:flexibleHeight(16)];
        ...
        UILabel *textLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0,rect.size.width + flexibleWidth(20), rect.size.height+ flexibleHeight(10))];
        ...
        _contentView.layer.cornerRadius = flexibleHeight(5);
