...
@interface MyActivitiesView () <UITableViewDataSource, UITableViewDelegate>

@property (nonatomic ,strong) UITableView *tableView;

@end

@implementation MyActivitiesView
...
//    NSString *str = @"一天一充的Apple watch，停售的Google glass，消音的内裤。。。什么样的智能硬件才算合格的产品？听完王自如对智能硬件的吐槽，今晚我们一起来聊聊你知道的那些智能硬件，赶快戳链接参加讨论吧→_→";
