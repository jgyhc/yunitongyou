//
//  PreviousForgetViewController.m
//  viewController
//
...
@interface PreviousForgetViewController ()<UIGestureRecognizerDelegate>
...
- (UIButton *)completeButton {
    if (!_completeButton) {
        _completeButton = ({
            ...
            [button addTarget:self action:@selector(completeForgetEvent:) forControlEvents:UIControlEventTouchUpInside];
            button;
        });
    }
